...
It combines [event-driven](/workflows/api-reference/type-aliases/WorkflowEvent) programming, [async context](/workflows/api-reference/type-aliases/WorkflowContext) and [streaming](/workflows/api-reference/classes/WorkflowStream) to create a flexible and efficient way to handle data processing tasks.
...
With [workflowEvent](/workflows/api-reference/type-aliases/WorkflowEvent) and [createWorkflow](/workflows/api-reference/functions/createWorkflow), you can create a simple workflow that processes events.
...
From here, the sky is the limit. You can implement [branching](/workflows/common_patterns/branching.mdx), [looping](/workflows/common_patterns/loops.mdx), [human-in-the-loop](/workflows/common_patterns/human_in_the_loop.mdx), [map-reduce](/workflows/common_patterns/map_reduce.mdx), and more!

## Architecture

Workflows are built around components like events, steps/handlers, context, and more. Learn more about these components [here](/workflows/api-reference/).
