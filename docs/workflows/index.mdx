...
It combines [event-driven](/docs/workflows/api-reference/type-aliases/WorkflowEvent) programming, [async context](/docs/workflows/api-reference/type-aliases/WorkflowContext) and [streaming](/docs/workflows/api-reference/classes/WorkflowStream) to create a flexible and efficient way to handle data processing tasks.
...
With [workflowEvent](/docs/workflows/api-reference/type-aliases/WorkflowEvent) and [createWorkflow](/docs/workflows/api-reference/functions/createWorkflow), you can create a simple workflow that processes events.
...
Workflows are built around components like events, steps/handlers, context, and more. Learn more about these components [here](/docs/workflows/api-reference/).
